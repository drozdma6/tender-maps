...
public class ProcurementDetailScrapper extends AbstractScrapper{
    ...
    /**
     * Gets procurement date of publication. Function accepts multiple date formats to accept
     * format officially used on site (e.g. 16/03/2023, 11:21) and it's transformation after
     * JSoup.connect()(e.g. 16. 03. 2023 11:21). First one is used for testing where only JSoup.parse()is used,
     * and it does not make date format transformation.
     *
